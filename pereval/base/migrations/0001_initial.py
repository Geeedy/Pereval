# Generated by Django 5.0.1 on 2024-01-03 21:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('coord_id', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='base.coord')),
                ('level_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='base.level')),
                ('user_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='base.myuser')),
            ],
        ),
        migrations.CreateModel(
            name='Images',
            fields=[
                ...
                ('pereval_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='images', to='base.pereval')),
            ],
        ),
    ]
